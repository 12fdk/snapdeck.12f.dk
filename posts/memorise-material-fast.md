---
title: "How to memorise a lot of material fast — the method that works"
...
faq:
  ...
  - question: "Can I really memorise everything before an exam?"
    answer: "Probably not everything, and you do not need to. In most exams a focused understanding of the core concepts beats a shallow familiarity with every footnote. The system in this article is designed to extract the highest-yield material first — definitions, mechanisms, key comparisons — so you memorise the things that actually get asked."
  - question: "Is it better to write flashcards by hand or use an app?"
    answer: "Both work. Handwriting cards forces you to process the material twice — once when you read it and again when you write the question. An app is faster, which matters when you have hundreds of facts to cover. The method — turning material into questions and testing yourself — is what matters. The tool is secondary."
  - question: "What if I memorise something and then forget it again?"
    answer: "That is normal and expected. Memory decays over time, which is why the testing effect — actively recalling information rather than passively reviewing it — matters more than how many times you read a fact the first time. Each time you successfully recall something, the memory gets stronger. Missing a card is useful data: it tells you exactly what to revisit."
  - question: "How do I know if I actually know something or just recognise it?"
